<x-modal size="modal-xl" data-backdrop="static" data-keyboard="false">
    ...
    <div class="form-group">
        ...
        <textarea name="body" id="" rows="3" class="form-control summernote"></textarea>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input name="receiver" type="radio" class="custom-control-input" id="saya" value="Saya Sendiri">
                    <label class="custom-control-label font-weight-normal" for="saya">Saya Sendiri</label>
                </div>

                <div class="custom-control custom-radio">
                    <input name="receiver" type="radio" class="custom-control-input" id="keluarga"
                        value="Keluarga / Kerabat">
                    <label class="custom-control-label font-weight-normal" for="keluarga">Keluarga / Kerabat</label>
                </div>

                <div class="custom-control custom-radio">
                    <input name="receiver" type="radio" class="custom-control-input" id="organisasi"
                        value="Organisasi / Lembaga">
                    <label class="custom-control-label font-weight-normal" for="organisasi">Organisasi / Lembaga</label>
                </div>

                <div class="custom-control custom-radio">
                    <input name="receiver" type="radio" class="custom-control-input" id="lainya" value="Lainya">
                    <label class="custom-control-label font-weight-normal" for="lainya">Lainya</label>
                </div>
            </div>
        </div>
